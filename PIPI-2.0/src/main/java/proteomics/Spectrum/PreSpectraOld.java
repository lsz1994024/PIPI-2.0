...
public class PreSpectraOld {
    ...
    private TreeMap<Double, List<Integer>> massNumMap = new TreeMap<>();
    ...
    public PreSpectraOld(JMzReader spectraParser, Map<String, String> parameterMap, MassTool massToolObj, String ext) {
        ...
        double minPrecursorMass =  Double.valueOf(parameterMap.get("min_precursor_mass"));
        double maxPrecursorMass = Double.valueOf(parameterMap.get("max_precursor_mass"));
        ...
        while (spectrumIterator.hasNext()) {
            ...
            double precursorMass = precursorMz * precursorCharge - precursorCharge * massTable.get("PROTON");
            ...
            TreeMap<Double, Double> plMap = preSpectrumObj.preSpectrum(rawMzIntensityMap, precursorMass, precursorCharge, ms2Tolerance);
    ...
    public TreeMap<Double, List<Integer>> returnMassNumMap() {
        return massNumMap;
    }
}
